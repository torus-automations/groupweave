...
// import { setupHereWallet } from "@near-wallet-selector/here-wallet"; // Disabled due to Node.js dependencies
    ...
    try {
      this.selector = await setupWalletSelector({
        ...
        modules: [
          ...
          // }),
          // setupHereWallet(), // Disabled due to Node.js crypto dependencies
          setupHotWallet(),
          setupIntearWallet(),
